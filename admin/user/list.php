...
<div class="card card-line card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">List of Thesis Librarian</h3>
		<div class="card-tools">
			<a href="?page=user/manage_user" class="btn btn-flat btn-primary btn-secondary"><span class="fas fa-plus"></span>  Create New</a>
		</div>
	</div>
	<div class="card-body">
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td ><p class="m-0"><?php echo ($row['type'] == 1 )? "" : "Staff" ?></p></td>
							<td align="center">

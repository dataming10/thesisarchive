							...
							<td class="text-center">
								<?php
                                    switch($row['award_status']){
                                        case '1':
                                            echo "<span class='badge badge-success badge-award badge-pill'>Best Thesis</span>";
                                            break;
                                        case '0':
                                            echo "<span class='badge badge-secondary badge-pill'>None</span>";
                                            break;
                                    }
                                ?>
							</td>
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
									...
									<div class="dropdown-divider"></div>
				                    <a class="dropdown-item award_status" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>" data-status="<?php echo $row['award_status'] ?>"><i class="fa fa-star"></i> With Award</a>
									<div class="dropdown-divider"></div>
...
<script>
	$(document).ready(function(){
		...
		$('.award_status').click(function(){
            uni_modal("Update Details","archives/award_status.php?id="+$(this).attr('data-id')+"&status="+$(this).attr('data-status'))
        })
